...
type UsecaseMethod interface {
	...
	FindStatementByUploadID(ctx context.Context, uploadID string, filter repository.StatementFilter, page, size int) ([]*entity.Statement, error)
...
func (i Usecase) FindStatementByUploadID(ctx context.Context, uploadID string, filter repository.StatementFilter, page, size int) ([]*entity.Statement, error) {
